...
import type IReceita from '../interfaces/IReceteita';
...
export default {
  ...
  async created() {
    ...
    this.receitasEncontradas = receitas.filter((receita)=>{
      const fazerReceita = itensDeLista1EstaoEmLista2(receita.ingredientes, this.ingredientes)
...
<template>
  <section class="mostrar-receitas">
    ...
    <div v-else class="receitas-nao-encontradas">
      ...
      <img src="../assets/lista-vazia.png"
